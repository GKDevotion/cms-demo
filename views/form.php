            ...
            <div class="col-md-12">
                ...
                <div class="card custom-card">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <label for="mobile1">Mobile 1 <span class="required">*</span></label>
                            <input type="tel" id="mobile1" name="mobile1" placeholder="1000010000" value="<?= htmlspecialchars($_POST['mobile1'] ?? ($client['mobile1'] ?? '')); ?>" required>
                        </div>

                        <div class="col-md-3">
                            <label for="mobile2">Mobile 2</label>
                            <input type="tel" id="mobile2" name="mobile2" placeholder="1000010000" value="<?= htmlspecialchars($_POST['mobile2'] ?? ($client['mobile2'] ?? '')); ?>">
                        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    const inputs = document.querySelectorAll("#mobile1, #mobile2");
